...
class PasswordResetTest(APITestCase):
    ...
    confirm_reset_passaword_url = "/api/v1/users/reset_password_confirm/"
    ...
    def test_reset_password(self):
        ...
        # parse password reset email to get uid and token
        # second email
        ...
        response = self.client.post(self.confirm_reset_passaword_url, data, format="json")
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
...
class EmailVerificationTest(APITestCase):
    ...
    def test_activate_with_wrong_uid_token(self):
        ...
        # verify the mail with the wrong data
